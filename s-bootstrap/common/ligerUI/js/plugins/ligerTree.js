...
//                	alert($(obj).attr("class"));
                	//tenant权限下，每个节点如果有onMouseOver属性则多找一级父节点
                	if($(obj).attr("onMouseOver")!=""&&$(obj).attr("onMouseOver")!=null){
                		treeitem =$(obj).parent().parent().parent();
                	}else if($(obj).attr("class")!=""&&$(obj).attr("class")!=null&&$(obj).attr("class")=='addStyle'){
                		treeitem =$(obj).parent().parent().parent().parent();
                	}else{
                		treeitem = $(obj).parent().parent();
                	}
                }
